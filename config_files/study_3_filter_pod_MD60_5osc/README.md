# STUDY-3: POD filters - MD60 - 5 oscillations
...
<br>
    ```bash
    fabsim <remote-machine> mamico_run_ensemble:study_3_filter_pod_MD60_5osc
    ```

3. Fetch the results from the remote machine.
<br>
    ```bash
    fabsim <remote-machine> fetch_results:regex="*study_3_filter_pod_MD60_5osc*"
    ```
