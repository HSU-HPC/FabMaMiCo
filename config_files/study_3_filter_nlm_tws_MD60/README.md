# STUDY-3: NLM filters - MD60 - time-window-size
...
<br>
    ```bash
    fabsim hsuper mamico_run_ensemble:study_3_filter_nlm_tws_MD60,cores=1,job_wall_time="12:00:00",partition_name="small_shared"
    ```

3. Fetch the results from the remote machine.
<br>
    ```bash
    fabsim hsuper fetch_results:regex="*study_3_filter_nlm_tws_MD60*"
    ```
